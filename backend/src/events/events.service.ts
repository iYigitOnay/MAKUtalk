...
export class EventsService implements OnModuleInit {
  ...
  async create(userId: bigint, createEventDto: CreateEventDto) {
  ...
  async toggleAttendance(userId: bigint, eventId: bigint) {
