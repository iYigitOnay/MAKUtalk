      ...
      >
        ...
        >
          <div class="relative z-10">
            ...
            <h1
              class="text-3xl md:text-4xl font-black text-slate-900 dark:text-white tracking-tight mb-2 md:mb-4"
            >
              MAKU<span
            ...
            <p
              class="text-slate-500 dark:text-white/60 text-sm md:text-sm leading-relaxed max-w-[250px] font-medium mx-auto"
            >
              {{
                activeTab === "login"
        ...
        >
          <div class="w-full max-w-[360px] pb-24 md:pb-0">
            ...
            >
              ...
              <!-- STEP 2: Milestone Journey (Hikaye Akışı) -->
              <div
                v-else
                key="review"
              ...
              >
                <div class="space-y-1 mb-8">
                  <h2
                    class="text-2xl font-black text-gray-900 dark:text-white tracking-tighter uppercase italic whitespace-nowrap"
                  >
                    Yolculuk Başlıyor
                  </h2>
                  <p
                ...
                <div class="relative space-y-12 ml-4">
                  ...
                  >
                    <div
                      class="absolute top-0 left-0 w-full bg-gradient-to-b from-emerald-500 via-blue-500 to-purple-500 transition-all duration-1000 ease-in-out"
                      :style="{ height: agreementsAccepted ? '100%' : '33%' }"
                    ></div>
                  </div>
                  ...
                  <div class="relative flex items-center gap-6">
                    <div
                      class="z-10 w-6 h-6 rounded-full bg-emerald-500 border-4 border-white dark:border-[#161b27] shadow-lg shadow-emerald-500/20 flex items-center justify-center"
                    >
                      <svg
                  ...
                  <!-- Legal Point -->
                  <div
                    class="relative flex items-start gap-6 cursor-pointer"
                  ...
                  >
                    ...
                    >
                      <svg
                        ...
                        :class="agreementsAccepted ? 'scale-100' : 'scale-0'"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
                    ...
                    <div class="flex-1">
                      ...
                      <p
                        class="text-[11px] leading-relaxed font-bold mt-1 transition-colors"
                        :class="
                          agreementsAccepted
                      ...
                      >
                        <button
                          ...
                          class="underline decoration-blue-500/20"
                        >
                          Şartlar</button
                        >,
                        <button
                  ...
                  >
                    ...
                    >
                      <svg
                        class="w-3 h-3 text-white transition-transform duration-300"
                        :class="marketingConsent ? 'scale-100' : 'scale-0'"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
                    ...
                    <div class="flex-1">
                      ...
                      <p
                        class="text-[11px] font-bold mt-1 transition-colors"
                        :class="
                          marketingConsent
                            ? 'text-slate-700 dark:text-white/80'
                            : 'text-slate-400/60'
                      ...
                      >
                        ...
                        <button
                          ...
                          class="underline decoration-purple-500/20"
                        >
                          E-İleti
                        </button>
                ...
                <div class="flex flex-col gap-4 pt-8 text-center">
                  <button
                    ...
                    class="auth-btn py-4 shadow-xl relative overflow-hidden group"
                  >
                    <span class="relative z-10">{{
                      registerLoading
                        ? "MAKUtalk'A HOŞ GELDİN..."
                        : "Yolculuğu Başlat"
                    }}</span>
                    <div
          ...
          <div class="w-full max-w-[340px]">
            ...
            <form @submit.prevent="handleLogin" class="space-y-4">
              <input
                ...
                type="text"
                placeholder="E-posta veya Öğrenci No"
                class="auth-input shadow-inner"
              />
              <input
...
.auth-btn {
  @apply w-full py-3.5 rounded-xl text-white text-sm font-black bg-gradient-to-r from-blue-600 to-purple-600 shadow-lg active:scale-95 transition-all disabled:opacity-50;
}
</style>
...
const emailError = computed(() =>
  emailPrefix.value.includes("@") ? "Sadece mail ön ekini yazın." : null,
);
...
const handleLogin = async () => {
  ...
  try {
    const email = loginForm.value.email.includes("@")
