<template>
  ...
  >
    <div
      class="bg-white rounded-xl shadow-xl max-w-2xl w-full max-h-[80vh] flex flex-col"
    >
      <!-- Header -->
      <div class="flex items-center justify-between p-6 border-b">
        <h2 class="text-xl font-bold text-gray-900">Yorumlar</h2>
        <button
          @click="$emit('close')"
      ...
      <div class="flex-1 overflow-y-auto p-6 space-y-4">
        ...
        <div
          ...
          class="text-center py-8"
        >
          <p class="text-gray-500">Henüz yorum yok. İlk yorumu sen yap!</p>
        </div>
        ...
        >
          ...
          <div class="flex-1">
            ...
            <span class="text-xs text-gray-400 ml-3 mt-1">{{
      ...
      <!-- Comment Input -->
      <div v-if="authStore.isAuthenticated" class="p-6 border-t">
