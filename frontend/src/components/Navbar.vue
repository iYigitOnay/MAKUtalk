      ...
      <div v-if="showMobileMenu" class="fixed top-0 left-0 bottom-0 w-[280px] bg-white dark:bg-gray-950 z-[101] shadow-2xl sm:hidden flex flex-col overflow-hidden">
        ...
        <div class="flex-1 overflow-y-auto py-4">
          <div class="px-4 space-y-2">
            ...
            <!-- Academic Sections -->
            <div v-if="authStore.user?.role === 'ACADEMIC'" class="pt-4 mt-4 border-t border-slate-100 dark:border-gray-900">
              <button @click="handleNav('/academic')" class="w-full flex items-center gap-4 px-4 py-3.5 rounded-2xl bg-emerald-50 dark:bg-emerald-900/10 text-emerald-600 dark:text-emerald-400">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
